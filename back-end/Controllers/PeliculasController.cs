...
namespace back_end.Controllers
{
    ...
    public class PeliculasController : ControllerBase
    {
        ...
        public async Task<ActionResult<PeliculaDTO>> Get(int id)
        {
            ...
            if (await context.Ratings.AnyAsync(x => x.PeliculaId == id))
            {
                ...
                if (HttpContext.User.Identity.IsAuthenticated)
                {
                    ...
                    var ratingDB = await context.Ratings.FirstOrDefaultAsync
                        (x => x.UsuarioId == usuarioId && x.PeliculaId == id);
        ...
        {
            Console.WriteLine("PeliculasFiltrarDTO: " + peliculasFiltrarDTO);
            var peliculasQueryable = context.Peliculas.AsQueryable();
            Console.WriteLine("peliculasQueryable: " + peliculasQueryable);
            ...
            if (peliculasFiltrarDTO.GeneroId != 0)
            {
                peliculasQueryable = peliculasQueryable
                    .Where(x => x.PeliculasGeneros.Select(y => y.GeneroId).Contains(peliculasFiltrarDTO.GeneroId));
            }
        ...
        public async Task<ActionResult<PeliculasPutGetDTO>> PutGet(int id)
        {
            ...
            var generosNoSeleccionadoDTO = mapper.Map<List<GeneroDTO>>(generosNoSeleccionados);
